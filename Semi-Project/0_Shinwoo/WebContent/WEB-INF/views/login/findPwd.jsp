		    ...
		    <div>
				<table id="passTable">
					<tr  id ="id" height="70px">
						...
						<td> <input type="text" id="memberId" name="memberId" placeholder="학번입력"
								onfocus="this.placeholder = ''" onblur="this.placeholder = '학번입력'" required
								class="single-input"> <br><br><br></td>
					</tr>
					<tr id ="find">
						<th colspan="2"><a onclick="location.href='<%= request.getContextPath() %>/findPwd.lo'" class="genric-btn info-border circle" id="sendEmail">이메일로 임시 비밀번호 발송</a></th>
				</table>
			</div>
		</section>
		<script>
