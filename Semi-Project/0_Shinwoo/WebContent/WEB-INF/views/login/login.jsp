...
<body>
    ...
    <main>
		...
		<table id="logintable">
			...
			<tr>
				<td colspan="2" id="text"> 초기 비밀번호는 주민번호 앞자리 6글자입니다.<br><br>
				<div id="memberEnroll">
				 	<a onclick="location.href='<%= request.getContextPath() %>/findPwdForm.lo'" class="genric-btn link-border circle">비밀번호 찾기</a>
					
				</div>
				<td id="findPass"><br><a href="#" class="genric-btn info-border circle">로그인</a></td>
			</tr>
		</table>
		</form>
    </section>
