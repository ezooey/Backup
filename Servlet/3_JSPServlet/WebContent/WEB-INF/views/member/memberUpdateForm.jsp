...
<%
	...
	String interest = myInfo.getInterest();
	
	String[] checked = new String[6];
	if(!interest.equals("null")){
		String[] splitStr = interest.split(","); //무조건적인 건 아님 DB확인
		...
		<form action="<%= request.getContextPath() %>/update.me" method="post" id="updateForm" name="updateForm">
			<table>
				...
				<tr>
					...
					<td><input type="text" name="myName" required value="<%= userName %>"></td>
				</tr>
				<tr>
					<td><label class="must">*</label> 닉네임</td>
					<td><input type="text" maxlength="15" name="myNickName" required value="<%= nickName %>"></td>
				...
				<tr>
					<td>주소</td>
					<td><input type="text" name="myAddress" value="<%= address %>"></td>
				</tr>
				<tr>
					<td>관심분야</td>
					<td>
